...
router.get('/', async (req, res) => {
  try {
    const { page, limit, is_paying, payment_category, access_type } = req.query;
    const result = await getUsersFiltered({ page, limit, is_paying, payment_category, access_type });
    res.json(result);
  } catch (error) {
